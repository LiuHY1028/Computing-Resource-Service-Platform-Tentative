...
export async function queryStorageSpaces(query: StorageQuery = {}) {
...
export async function getStorageSpace(storageId: string) {
  await Promise.resolve();
...
export function resetStorageRepository() {
